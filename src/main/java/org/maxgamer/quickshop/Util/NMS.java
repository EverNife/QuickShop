	...
	static {
		nmsDependencies.add(new NMSDependent("v1_7") {			
			...
			public void safeGuard(Item item) {
				...
				net.minecraft.server.v1_7_R4.ItemStack nmsI = org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack.asNMSCopy(iStack);
				nmsI.count = 0;
			...
			public byte[] getNBTBytes(org.bukkit.inventory.ItemStack iStack) {
				...
				net.minecraft.server.v1_7_R4.ItemStack is = org.bukkit.craftbukkit.v1_7_R4.inventory.CraftItemStack.asNMSCopy(iStack);
			...
			public org.bukkit.inventory.ItemStack getItemStack(byte[] bytes) {
				...
				net.minecraft.server.v1_7_R4.NBTTagCompound c = net.minecraft.server.v1_7_R4.NBTCompressedStreamTools.a(bytes, null);
			...
			public GenericPotionData getPotionData(ItemStack potionItemStack) {
				...
				return new GenericPotionData(potion.getType(), potion.getEffects(), category, potion.getType()==PotionType.WATER && !potion.getEffects().isEmpty(), potion.hasExtendedDuration() ? -1 : 0, potion.getLevel() == 2 ? 2 : 1);
			}
